        ...
        */
        ...
        //画像拡大表示
        const profModalWrapperElm=document.querySelectorAll('.profModalWrapper');
        const profModalImageElm=document.querySelectorAll('.profModalImage');
        const profImagesElm=document.querySelectorAll('.profImage');

        console.log(profImagesElm);
        console.log(profModalWrapperElm);
        console.log(profModalImageElm);
