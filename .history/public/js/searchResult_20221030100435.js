        ...
        */
        ...
        async function searchConditionChange(){
            xxx=searchCheckedElm1.checked;
            console.log(xxx);
        }



        let searchCheckedElm1=document.querySelectorAll('input[name="keyword1"]');
        console.log(searchCheckedElm1);
        searchCheckedElm1.addEventListener('change',searchConditionChange);
