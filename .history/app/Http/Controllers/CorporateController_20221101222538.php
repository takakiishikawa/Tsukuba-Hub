...
class CorporateController extends Controller
{
    ...
    public function log(){
        ...
        foreach($niceCreatedRecords as $niceCreatedRecord){
            $niceCreatedList[]=$niceCreatedRecord->created_at;
        }
        $niceEngineerNameList=[];
        foreach($niceCreatedRecords as $niceCreatedRecord){
            $niceEngineerNameList[]=$niceCreatedRecord->engineer_name;
        }

        return response()->json([
            'logged'=>$logged,
            'niceCreatedList'=>$niceCreatedList,
            'niceEngineerNameList'=>$niceEngineerNameList,
        ]);
    }
}
