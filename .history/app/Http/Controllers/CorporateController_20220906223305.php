...
class CorporateController extends Controller
{
    public function index(Request $request){
        ...
        $selection_flow=SelectionFlow::where('user_id',Auth::user()->id)->get();
        $selection_flow_id=$selection_flow->id;
        $selection_stages=SelectionStage::where('selection_flow_id',$selection_flow->id)->get();
