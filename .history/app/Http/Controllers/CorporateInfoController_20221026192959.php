...
class CorporateInfoController extends Controller{
    public function index(Request $request){
        ...
        $corporate_info=CorporateInfo::where('user_id',$user_id)->first();


        return view('corporate.top.corporate-info-index')
            ->with('corporate_info',$corporate_info);
    ...
    public function create(Request $request){
        ...
        $dir='corporateProf';
        $image = $uploadedFile->getClientOriginalName(); //ブラウザ側で知りえたオリジナルのファイル名
        $uploadedFile->storeAs('public/'.$dir,$image);
