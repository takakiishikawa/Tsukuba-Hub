            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search',['id'=>1])}}" method="GET">
                        ...
                        インフラ：<input type="checkbox" name="keyword7" value="AWS" <?php if(@$_GET['keyword7']=='AWS') 'checked';?>>AWS
                        <input type="checkbox" name="keyword7" value="GCP" <?php if(@$_GET['keyword7']=='GCP') 'checked';?>> GCP
                        <input type="checkbox" name="keyword7" value="Azure" <?php if(@$_GET['keyword7']=='Azure') 'checked';?>> Azure
                        <input type="checkbox" name="keyword7" value="Alibaba Cloud" <?php if(@$_GET['keyword7']=='Alibaba Cloud') 'checked';?>> Alibaba Cloud
                        <input type="checkbox" name="keyword7" value="IBM Cloud" <?php if(@$_GET['keyword7']=='IBM Cloud') 'checked';?>> IBM Cloud<br><br>
                        ...
                        <p style=color:red;>注：まだここだけ</p>
                        関心：<input type="checkbox" name="keyword11" value="WEB" <?php if(@$_GET['keyword11']=='WEB') 'checked';?>>WEB
