            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search')}}" method="GET">
                        ...
                        <input type="submit" value="この条件で検索する" style="color:#a5a6a6;font-weight:bold;cursor:pointer;"><span id="result"></span>
                    </form>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('corporate.unnice',['id'=>$engineer_info->user_id])}}" style="color:#90c8a2;font-weight:bold">いいね済&emsp;&emsp;</a></td>
                            @elseif(array_key_exists( $engineer_info->user_id , $nicedList ))
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="color:#70c0bf;font-weight:bold">いいねあり！&emsp;&emsp;</a></td>
                            @else
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="color:#898a89;font-weight:bold">いいね&emsp;&emsp;</a></td>
                            @endif
                            <td>詳細</td>
                        </tr>
                        @endforeach
