                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>{{$engineer_info->user->user_login->logged_at}}</p>
                                <?php
                                ...
                                ?>
                                @if($loggedTimeStamp>$beforeOneWeekTimeStamp)
                                <img src="../../../img/oneWeek.png">
                                @elseif($loggedTimeStamp>$beforeThreeDaysTimeStamp)
                                <p>soso</p>
                                @else
                                <p>bad</p>
                                @endif
