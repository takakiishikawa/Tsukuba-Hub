                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="color:#7ecccb;font-weight:bold">相手からいいねあり！&emsp;&emsp;</a></td>
                            @else
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="color:#cecbcb;font-weight:bold">いいね&emsp;&emsp;</a></td>
                            @endif
                            <td>詳細</td>
                        </tr>
                        @endforeach
