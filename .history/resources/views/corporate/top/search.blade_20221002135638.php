            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search')}}" method="GET">
                        ...
                        年齢：<input type="number" name="keyword12"><br><br>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>仕事に求めるもの:{{$engineer_info->expectation}}&emsp;&emsp;<br>
                                ...
                                {{$engineer_info->user->engineer_name}}
                            </td>


                            @if($engineer_info->user->nice)
                            <td><a href="{{route('corporate.unnice',['id'=>$engineer_info->user_id])}}">いいね済&emsp;&emsp;</a></td>
                            @elseif ($engineer_info->user->both_nice->engineer_name===$engineer_info->user->engineer_name)
                            <td>マッチング済&emsp;&emsp;</td>
                            @else
