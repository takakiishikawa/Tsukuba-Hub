            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search',['id'=>1])}}" method="GET">
                        ...
                        強み：<input type="checkbox" name="keyword10" value="論理的思考力" <?php if(@$_GET['keyword10']) echo 'checked' ?>>論理的思考力
                        <input type="checkbox" name="keyword10" value="具体⇄抽象の横断" <?php if(@$_GET['keyword10']) echo 'checked' ?>>具体⇄抽象の横断
                        <input type="checkbox" name="keyword10" value="思考スピード" <?php if(@$_GET['keyword10']) echo 'checked' ?>>思考スピード
                        <input type="checkbox" name="keyword10" value="一つのことを考え続ける力" <?php if(@$_GET['keyword10']) echo 'checked' ?>>一つのことを考え続ける力
                        <input type="checkbox" name="keyword10" value="楽観的な態度" <?php if(@$_GET['keyword10']) echo 'checked' ?>>楽観的な態度
                        <input type="checkbox" name="keyword10" value="自分を信じる力" <?php if(@$_GET['keyword10']) echo 'checked' ?>>自分を信じる力
                        <input type="checkbox" name="keyword10" value="他自然言語の習得速度" <?php if(@$_GET['keyword10']) echo 'checked' ?>>他自然言語の習得速度
                        <input type="checkbox" name="keyword10" value="他者への興味関心" <?php if(@$_GET['keyword10']) echo 'checked' ?>>他者への興味関心
                        <input type="checkbox" name="keyword10" value="技術への高い好奇心" <?php if(@$_GET['keyword10']) echo 'checked' ?>>技術への高い好奇心
                        <input type="checkbox" name="keyword10" value="高度な実装力" <?php if(@$_GET['keyword10']) echo 'checked' ?>>高度な実装力
                        <input type="checkbox" name="keyword10" value="人間理解" <?php if(@$_GET['keyword10']) echo 'checked' ?>>人間理解<br><br>
