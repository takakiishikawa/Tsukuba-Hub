                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    新しい情報<br><br>
                     <form action="{{route('corporate.corporate-info-update')}}" method="POST">
                        ...
                        ミッション - タイトル：<input type="text" name="mission_title" value="{{old('mission_title',$corporate_info->mission_title)}}" cols="135" rows="5"><br><br>

                        ミッション - 本文：<input type="text" name="mission_content" value="{{ old('mission_content') }}"><br><br>
                        プロダクト名：<input type="text" name="product_name" value = "{{ old('product_name') }}"><br><br>
                        プロダクト内容：<input type="text" name="product_content" cols="135" rows="5"><br><br>
                        <textarea name="content" id="content" cols="135" rows="5" placeholder="メッセージをご入力ください"></textarea>
                        ...
                        画像：<input type="text" name="image"><br><br>
