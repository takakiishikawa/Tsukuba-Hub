            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search')}}" method="GET">
                        ...
                        <input type="submit" value="この条件で検索する" style="background-color:#b2d700">
                    </form>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a style="background-color:#ea9e99">マッチング中&emsp;&emsp;</a></td>
                            @elseif(array_key_exists( $engineer_info->user_id , $niceList ))
                            <td><a href="{{route('corporate.unnice',['id'=>$engineer_info->user_id])}}" style="color:#b2d700;font-weight:bold">いいね済&emsp;&emsp;</a></td>
                            @elseif(array_key_exists( $engineer_info->user_id , $nicedList ))
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#b2d700;font-weight:bold">相手からいいねあり！&emsp;&emsp;</a></td>
                            @else
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#b2d700;font-weight:bold">いいね&emsp;&emsp;</a></td>
                            @endif
                            <td>詳細</td>
                        </tr>
                        @endforeach
