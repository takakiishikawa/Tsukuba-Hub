                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                echo $engineer_info->user->user_id;
                                ?>
                                受け取ったいいね数:{{array_count_values($niceList,$engineer_info->user->user_id)}}&emsp;&emsp;</td>
                                @else
                            ...
                            @elseif(array_key_exists( $engineer_info->user_id , $myNniceList ))
