                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            @if($engineer_info->user->nice::where('engineer_name',$engineer_info->user->engineer_name) && $engineer_info->user->nice::where('name',$user_name $$ $engineer_info->user->name==="フラペチーノ" ))
