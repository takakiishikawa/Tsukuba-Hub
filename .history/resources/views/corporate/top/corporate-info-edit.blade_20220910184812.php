                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    新しい情報<br><br>
                     <form action="{{route('corporate.corporate-info-update')}}" method="POST">
                        ...
                        創業年月：<input type="date" name="founded" value="{{ old('mission_content',$corporate_info->founded)}}"><br><br>
                        本社 - 都市：<input type="text" name="headquarters_city"value="{{ old('mission_content',$corporate_info->headquarters_city)}}"><br><br>
                        画像：<input type="text" name="image" value="{{ old('mission_content',$corporate_info->image)}}"><br><br>

                        シリーズ：<select name="series" value="{{ old('mission_content',$corporate_info->series)}}">
                        ...
                        プロダクト名：<input type="text" name="product_name" value="{{ old('mission_content',$corporate_info->product_name)}}" style="width:500px"><br><br>
                        プロダクト内容：<input type="text" name="product_content"value="{{ old('mission_content',$corporate_info->product_content)}}" style="width:500px;height:100px"><br><br>
