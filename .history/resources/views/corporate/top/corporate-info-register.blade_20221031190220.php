<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   <p>企業情報登録</p><br>
                   <form action="{{route('corporate.corporate-info-create')}}" method="POST" enctype='multipart/form-data' class="validationForm">
                   <input type="hidden" name="_token" value="{{csrf_token()}}">
                   創業年月：<input type="date" name="founded" class="required"><br><br>
                   本社 - 都市：<input type="text" name="headquarters_city"  class="required"><br><br>
                   シリーズ：<select name="series" class="required">
                   ...
                   ミッション - タイトル：<input type="text" name="mission_title" style="width:500px" class="required"><br><br>
                   ミッション - 本文：<input type="text" name="mission_content" style="width:500px;height:100px" class="required"><br><br>
                   プロダクト名：<input type="text" name="product_name" style="width:500px" class="required"><br><br>
                   プロダクト内容：<input type="text" name="product_content" style="width:500px;height:100px" class="required"><br><br>
                   ...
                   画像：<input type="file" name="image" class="required"><br><br>
    ...
    <script src="../../../js/corporate-info-register.js"></script>
</x-app-layout>
