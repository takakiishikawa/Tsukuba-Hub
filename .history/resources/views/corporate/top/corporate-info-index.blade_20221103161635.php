...
<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   ...
                   <a href="{{route('corporate.corporate-info-edit',['id'=>$corporate_info->id])}}" style="color:#a36fbd;font-weight:bold;cursor:pointer;">編集する</a><br><br>
    ...
    <script src="../../../js/corporate-info-index.js"></script>
