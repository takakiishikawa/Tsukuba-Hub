                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>{{$engineer_info->user_id}}</p>
                                @if(array_key_exists( $engineer_info->user_id , $nicedList ))
                                <p>わい</p>
                                @else
                                <p>x</p>
                                @endif
                            ...
                            <td><a style="background-color:#e5e7eb">マッチング中&emsp;&emsp;</a></td>
                            @elseif(array_key_exists( $engineer_info->user_id , $niceList ))
                            ...
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#e5e7eb">相手からいいねあり！&emsp;&emsp;</a></td>
                            @else
