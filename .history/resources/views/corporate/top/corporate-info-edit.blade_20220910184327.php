                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    新しい情報<br><br>
                     <form action="{{route('corporate.corporate-info-update')}}" method="POST">
                        ...
                        ミッション - 本文：<input type="text" name="mission_content" value="{{ old('mission_content') }}" style="width:500px"><br><br>
                        プロダクト名：<input type="text" name="product_name" value = "{{ old('product_name') }}" style="width:500px"><br><br>
                        プロダクト内容：<input type="text" name="product_content" style="width:500px,height:500px"><br><br>
