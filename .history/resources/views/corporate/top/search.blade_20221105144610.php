            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search',['id'=>1])}}" method="GET">
                        ...
                        強み：<input type="checkbox" name="keyword10" value="論理的思考力" <?php if(@$_GET['keyword11']) echo 'checked' ?>>論理的思考力
                        <input type="checkbox" name="keyword10" value="具体⇄抽象の横断" <?php if(@$_GET['keyword11']) echo 'checked' ?>>具体⇄抽象の横断
                        <input type="checkbox" name="keyword10" value="思考スピード" <?php if(@$_GET['keyword11']) echo 'checked' ?>>思考スピード
                        <input type="checkbox" name="keyword10" value="一つのことを考え続ける力" <?php if(@$_GET['keyword11']) echo 'checked' ?>>一つのことを考え続ける力
                        <input type="checkbox" name="keyword10" value="楽観的な態度" <?php if(@$_GET['keyword11']) echo 'checked' ?>>楽観的な態度
                        <input type="checkbox" name="keyword10" value="自分を信じる力" <?php if(@$_GET['keyword11']) echo 'checked' ?>>自分を信じる力
                        <input type="checkbox" name="keyword10" value="他自然言語の習得速度" <?php if(@$_GET['keyword11']) echo 'checked' ?>>他自然言語の習得速度
                        <input type="checkbox" name="keyword10" value="他者への興味関心" <?php if(@$_GET['keyword11']) echo 'checked' ?>>他者への興味関心
                        <input type="checkbox" name="keyword10" value="技術への高い好奇心" <?php if(@$_GET['keyword11']) echo 'checked' ?>>技術への高い好奇心
                        <input type="checkbox" name="keyword10" value="高度な実装力" <?php if(@$_GET['keyword11']) echo 'checked' ?>>高度な実装力
                        <input type="checkbox" name="keyword10" value="人間理解" <?php if(@$_GET['keyword11']) echo 'checked' ?>>人間理解<br><br>

                        関心：<input type="checkbox" name="keyword11" value="WEB" <?php if(@$_GET['keyword11']) echo 'checked' ?>>WEB
                        <input type="checkbox" name="keyword11" value="スマホアプリ開発" <?php if(@$_GET['keyword11']) echo 'checked' ?>>スマホアプリ開発
                        <input type="checkbox" name="keyword11" value="データベース" <?php if(@$_GET['keyword11']) echo 'checked' ?>>データベース
                        <input type="checkbox" name="keyword11" value="API" <?php if(@$_GET['keyword11']) echo 'checked' ?>>API
                        <input type="checkbox" name="keyword11" value="ミドルウェア開発" <?php if(@$_GET['keyword11']) echo 'checked' ?>>ミドルウェア開発
                        <input type="checkbox" name="keyword11" value="組み込み開発" <?php if(@$_GET['keyword11']) echo 'checked' ?>>組み込み開発
                        <input type="checkbox" name="keyword11" value="セキュリティ" <?php if(@$_GET['keyword11']) echo 'checked' ?>>セキュリティ
                        <input type="checkbox" name="keyword11" value="データサイエンス" <?php if(@$_GET['keyword11']) echo 'checked' ?>>データサイエンス
                        <input type="checkbox" name="keyword11" value="機械学習/AI" <?php if(@$_GET['keyword11']) echo 'checked' ?>>機械学習/AI
                        <input type="checkbox" name="keyword11" value="自然言語処理" <?php if(@$_GET['keyword11']) echo 'checked' ?>>自然言語処理
                        <input type="checkbox" name="keyword11" value="大規模開発" <?php if(@$_GET['keyword11']) echo 'checked' ?>>大規模開発<br><br>
