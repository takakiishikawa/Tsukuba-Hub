    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <p>検索機能</p><br>
                <div>
                    <form action="{{route('corporate.search')}}" method="GET" enctype="multipart/form-data">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            @if(array_key_exists( $engineer_info->user_id , $niceList ))
    ...
    <script>
        function selectionResult() {
            ...
            .then(function(result) {
                ...
                console.log(ageResult.textContent);
            });
        }
