            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        @if(in_array($nice->user->engineer_name,$bothNiceList))
                        <td><a style="color:#a36fbd;font-weight:bold">マッチング中&emsp;&emsp;</a></td>
                        @elseif(array_key_exists( $nice->user->id , $myNiceList ))
                        ...
                        @else
                        <td><a href="{{route('corporate.nice',['id'=>$nice->user->id])}}" style="color:#b9b9b9;font-weight:bold">いいね&emsp;&emsp;</a></td>
                        @endif
                        <td>a</td>
                    </tr>
                    @endforeach
