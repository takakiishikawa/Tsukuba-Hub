        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <p>求人情報編集</p><br><br>
                    現在：<br><br>
                    プロダクト名：{{$CorporateInfo->job_type}}<br><br>
                    プロダクト内容：{{$CorporateInfo->position}}<br><br>
                    シリーズ：{{$CorporateInfo->job_description}}<br><br><br><br><br>
                    タグ：{{$CorporateInfo->job_description}}<br><br><br><br><br>
                    新しい情報：<br><br>
