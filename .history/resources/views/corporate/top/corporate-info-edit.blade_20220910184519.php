                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    新しい情報<br><br>
                     <form action="{{route('corporate.corporate-info-update')}}" method="POST">
                        ...
                        ミッション - 本文：<input type="text" name="mission_content" value="{{ old('mission_content') }}" style="width:500px;height:100px"><br><br>
                        ...
                        <input type="submit" value="編集する" style="color:#e5e7eb"><br><br>
                    </form>
                 </form>
                </div>
            </div>
