                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#b2d700">相手からいいねあり！&emsp;&emsp;</a></td>
                            @else
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#b2d700">いいね&emsp;&emsp;</a></td>
                            @endif
                            <td>詳細</td>
                        </tr>
                        @endforeach
