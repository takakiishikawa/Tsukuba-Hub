...
<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search')}}" method="GET">
                        ...
                        <input type="submit" value="この条件で検索する" style="background-color:#e5e7eb">
                    </form>

                </div><br><br>
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1>検索結果　{{$searchResultCount}}名</h1><br>
                    <h1 class="aiueo">アイウ</h1>
                    <table>
                        <tr>
                            <th>名前</th>
                            <th>職種</th>
                        ...
                        <tr>
                            ...
                            <div class="prof">
                                <img src="{{asset($engineer_info->path)}}" width="100px" class="image" data-src="{{asset($engineer_info->path)}}">
                            </div>
                            </td>
                            <td>
                            ...
                            <td><a href="{{route('corporate.unnice',['id'=>$engineer_info->user_id])}}" style="background-color:#e5e7eb">いいね済&emsp;&emsp;</a></td>
                            @else
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="background-color:#e5e7eb">いいね&emsp;&emsp;</a></td>
                            @endif
                            <td>詳細</td>
                        </tr>
                        @endforeach
    ...
    <script src="../../../js/profMordal.js"></script>
