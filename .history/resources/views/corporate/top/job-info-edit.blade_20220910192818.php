        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   ...
                   仕事内容：<input type="text" name="job_content" value="{{old('job_content',$job_info->job_content)}}"><br><br>
                   ...
                   必須技術：<input type="text" name="must_technology" value="{{old('must_technology',$job_info->must_technology)}}"><br><br>
                   歓迎技術：<input type="text" name="better_technology" value="{{old('better_technology',$job_info->better_technology)}}"><br><br>
                   必須人物：<input type="text" name="must_personality" value="{{old('must_personality',$job_info->must_personality)}}"><br><br>
                   歓迎人物：<input type="text" name="better_personality" value="{{old('better_personality',$job_info->better_personality)}}"><br><br>
                   ...
                   勤務地 - 都市名：<input type="text" name="work_city" value="{{old('work_city',$job_info->work_city)}}"><br><br>
                    <input type="submit" value="送信" style="background-color: #e5e7eb"><br><br>
                </form>
                </div>
