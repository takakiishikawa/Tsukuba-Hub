            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div>
                    <form action="{{route('corporate.search')}}" method="GET">
                        ...
                        <input type="submit" value="この条件で検索する" style="color:#a36fbd;font-weight:bold;cursor: pointer;">
                    </form>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('corporate.nice',['id'=>$engineer_info->user_id])}}" style="color:#a0e2e6;font-weight:bold">相手からいいねあり！&emsp;&emsp;</a></td>
                            @else
