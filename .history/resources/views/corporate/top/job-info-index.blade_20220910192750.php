        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   <p>求人情報</p><br>
                   <a href="{{route('corporate.job-info-register')}}"  style="background-color: #e5e7eb">求人を新規登録する</a><br><br>
                   ...
                   <li>
                        ...
                        <a href="{{route('corporate.job-info-edit',['id'=>$job_info->id])}}"  style="background-color: #e5e7eb">編集する</a>
                    </li><br><br>
                    @endforeach
                </div>
            </div>
