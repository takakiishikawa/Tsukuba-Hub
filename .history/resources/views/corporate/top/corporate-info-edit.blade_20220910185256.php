                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    新しい情報<br><br>
                     <form action="{{route('corporate.corporate-info-update')}}" method="POST">
                        ...
                        シリーズ：<select name="series" value="{{ old('series',$corporate_info->series)}}">
                        ...
                        開発言語：<input type="checkbox" name="development_language" value="{{ old('mission_content',$corporate_info->development_language)}}> C
