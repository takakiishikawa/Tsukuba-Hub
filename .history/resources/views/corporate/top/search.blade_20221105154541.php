        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="sort">並び替え
                        <p><a href="{{route('corporate.search',['id'=>1,'sort',=>'sortNew'])}}">新規登録順</a></p>
                        <p><a href="{{route('corporate.search',['id'=>1,'sort'=>'sortPopular'])}}">人気順</a></p>
                        <p><a href="{{route('corporate.search',['id'=>1,'sort'=>'sortActive'])}}">アクティブ順</a></p>
                    </div>
                    <table>
                        <tr>
                            <th>画像</th>
