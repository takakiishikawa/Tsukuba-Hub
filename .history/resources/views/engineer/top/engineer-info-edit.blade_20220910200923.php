            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   ...
                   <form action="{{route('engineer.engineer-info-update')}}" method="POST">
                    ...
                    経験職種 - 年数：<input type="number" name="work_experience_year" value="{{old('work_experience_year',$engineer_info->work_experience_year)}}"><br><br>
                    ...
                    年齢：<input type="number" name="age" value="{{old('age',$engineer_info->age)}}"><br><br>
                    住所 - 都市名：<input type="text" name="address_city" value="{{old('address_city',$engineer_info->address_city)}}"><br><br>
                    PR動画：<input type="text" name="video" value="{{old('video',$engineer_info->video)}}"><br><br>
                    プロフィール画像：<input type="text" name="image" value="{{old('image',$engineer_info->image)}}"><br><br>
