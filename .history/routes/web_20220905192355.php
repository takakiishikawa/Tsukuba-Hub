...
Route::get('/corporate/nice/',[NiceListController::class,'niceList'])->name('corporate.nice-list');
Route::get('/corporate/nice/',[NiceListController::class,'nicedList'])->name('corporate.nice-list');

Route::get('/corporate/selection/',[SelectionController::class,'index'])->name('corporate.selection');
...
Route::get('/engineer/nice/',[NiceListController::class,'niceList'])->name('engineer.nice-list');
Route::get('/engineer/nice/',[NiceListController::class,'nicedList'])->name('engineer.nice-list');


Route::get('/engineer/selection/',[SelectionController::class,'index'])->name('engineer.selection');
