...
Route::get('/corporate/message/',[MessageController::class,'send'])->name('corporate.message');
Route::get('/corporate/message/',[MessageController::class,'display'])->name('corporate.message');
