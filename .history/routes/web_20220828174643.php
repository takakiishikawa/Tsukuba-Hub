...
Route::get('/corporate/nice/',[NiceManageController::class,'nice'])->name('corporate.nice');
Route::get('/corporate/nice/',[NiceManageController::class,'unNice'])->name('corporate.nice');
