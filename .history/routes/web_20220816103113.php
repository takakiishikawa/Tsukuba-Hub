...
Route::get('/corporate/',[CorporateController::class,'index'],[SelectionStage::class,'interviewCount'])->name('corporate.top');
...
Route::get('/corporate/',)->name('corporate');

Route::get('/corporate/search/',[FromCorporateSearch::class,'select'])->name('corporate.search');
Route::get('/corporate/search/',[FromCorporateSearch::class,'search'])->name('corporate.search');
Route::get('/corporate/search/',[FromCorporateSearch::class,'sort'])->name('corporate.search');
