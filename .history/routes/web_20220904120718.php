...
use App\Http\Controllers\FromEngineerSearchController;
...
Route::get('/corporate/nice/{id}',[NiceManageController::class,'corporateNice'])->name('corporate.nice');
Route::get('/corporate/nice/{id}',[NiceManageController::class,'corporateUnnice'])->name('corporate.unnice');
...
Route::get('/engineer/nice/',[NiceManageController::class,'indexEngineer'])->name('engineer.nice');
Route::get('/engineer/selection/',[BothNiceManageController::class,'indexEngineer'])->name('engineer.selection');
