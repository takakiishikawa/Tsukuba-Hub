...
})->middleware(['auth'])->name('corporate.top');
...
Route::get('/corporate/job-info-index/',[JobInfoController::class,'register'])->name('corporate.job-info-register');
Route::
...
Route::get('/corporate/corporate-info-index/',[CorporateInfoController::class,'register'])->name('corporate.corporate-info-register');
