...
Route::get('/corporate/nice/',[NiceListController::class,'corporatenNicedList'])->name('corporate.nice-list');
...
Route::get('/engineer/nice/',[NiceListController::class,'engineerNicedList'])->name('engineer.nice-list');
