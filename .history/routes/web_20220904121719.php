...
Route::get('/corporate/nice/{id}',[NiceController::class,'corporateNice'])->name('corporate.nice');
Route::get('/corporate/nice/{id}',[NiceController::class,'corporateUnnice'])->name('corporate.unnice');
