...
Route::get('/corporate/job-info-index/',[JobInfoController::class,'index'])->name('corporate.job.index');
...
Route::get('/corporate/corporate-info-index/',[CorporateInfoController::class,'index'])->name('corporate.corporate.index');
