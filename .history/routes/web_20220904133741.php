...
Route::get('/corporate/search/{id}',[NiceController::class,'corporateNice'])->name('corporate.nice');
Route::get('/corporate/search/{id}',[NiceController::class,'corporateUnnice'])->name('corporate.unnice');
