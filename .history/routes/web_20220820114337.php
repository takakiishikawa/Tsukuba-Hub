...
Route::get('/corporate/job-info-index/',[JobInfoController::class,'index'])->name('corporate.job-info-register');
Route::
...
Route::get('/corporate/corporate-info-index/',[CorporateInfoController::class,'index'])->name('corporate.corporate-info-register');
