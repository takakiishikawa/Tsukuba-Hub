...
Route::get('/corporate/nice/',[NiceListController::class,'index'])->name('corporate.nice-list');
...
Route::get('/engineer/search/',[SearchController::class,'engineerSearch'])->name('corporate.search');
