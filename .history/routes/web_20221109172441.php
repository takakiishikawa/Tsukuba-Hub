...
Route::get('/nice-modal/',[CorporateController::class,'log']);
Route::get('/time-line/',[CorporateController::class,'timeLine']);



Route::get('/corporate/search/{id}/',[SearchController::class,'corporateSearch'])->name('corporate.search');
Route::get('/engineer-infos/',[SearchController::class,'engineerPagination']);
...
Route::get('/corporate/selection/',[SelectionManageController::class,'corporateIndex'])->name('corporate.selection');
Route::post('/corporate/selection-create/',[SelectionManageController::class,'corporateSelectionMessage'])->name('corporate.selection-message');
Route::get('/api/corporate/selection/',[SelectionManageController::class,'apiCorporateIndex']);
...
Route::get('/job-tab/',[JobInfoController::class,'jobTab']);
...
Route::get('/corporate/selection-flow-index/',[SelectionFlowController::class,'index'])->name('corporate.selection-flow-index');
...
Route::get('/engineer/selection/',[SelectionManageController::class,'engineerIndex'])->name('engineer.selection');
Route::post('/engineer/selection-create/',[SelectionManageController::class,'engineerSelectionMessage'])->name('engineer.selection-create');
...
Route::get('/api/ageResult/{age}',[SearchController::class,'ageResult']);

Route::post('/api/',[SearchController::class,'result']);

Route::get('/api/',[SearchController::class,'corporateSearch']);
