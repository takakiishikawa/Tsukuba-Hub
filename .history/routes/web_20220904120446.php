...
Route::get('/corporate/nice/',[NiceManageController::class,'corporateNice'])->name('corporate.nice');
Route::get('/corporate/nice/',[NiceManageController::class,'corporateUnnice'])->name('corporate.unnice');
