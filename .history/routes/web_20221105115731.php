...
Route::get('/engineer-infos/',[SearchController::class,'pagination']);
Route::get('/corporate/search/{id}',[SearchController::class,'corporateSearch'])->name('corporate.pagination','corporate.search')->name('corporate.search');
